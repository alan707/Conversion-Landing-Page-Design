...
def value_prop_section(
    ...
    return rx.el.section(
        rx.el.div(
            rx.el.h2(
                headline,
                class_name="text-[28px] md:text-[32px] font-bold text-[#0F172A] mb-6",
            ),
            rx.el.p(
                body,
                class_name="text-[18px] md:text-[20px] text-[#64748B] leading-relaxed max-w-3xl",
            ),
            class_name="max-w-5xl mx-auto px-6",
        ),
        class_name=f"{bg_color} {padding_y} w-full",
    )
